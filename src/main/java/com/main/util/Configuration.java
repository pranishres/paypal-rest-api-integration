...
public class Configuration {
	// Creates a configuration map containing credentials and other required configuration parameters.
		public static final Map<String,String> getAcctAndConfig(){
			...
			// Account Credential
			configMap.put("acct1.UserName", "pranish.shres-facilitator_api1.gmail.com");
			configMap.put("acct1.Password", "SRKA8G89RNARXQNK");
			configMap.put("acct1.Signature", "AkTGvS0Cr0lWp-ZOyDDZPLzTuUzmARp5yTU6xkwsrlOk.u8fBL94H.TL");
